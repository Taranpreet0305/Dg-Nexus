  ...
  return (
    ...
    >
      ...
      <motion.svg
        ...
        whileHover={{ 
          filter: [
            'drop-shadow(0 0 8px hsl(var(--silver))) drop-shadow(0 0 15px hsl(var(--glow-silver)))',
            'drop-shadow(0 0 12px hsl(var(--silver))) drop-shadow(0 0 25px hsl(var(--glow-silver)))',
            'drop-shadow(0 0 8px hsl(var(--silver))) drop-shadow(0 0 15px hsl(var(--glow-silver)))',
          ]
        }}
        transition={{ 
